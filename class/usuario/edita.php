    ...
    <body>
        ...
        <main class="container">
            <form method="POST" action="update.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-4">
                        <img src= '<?php echo "../../images_users/" . $nome . '/' . $foto; ?>'class="rounded-circle" alt="" width="100" height="100">
                ...
                <div class="form-group col-lg-3">
                    ...
                    <input class="form-control" type="text" name="nome" value="<?php echo $usuarioVO->getNome(); ?>" readonly>
                </div>
                    ...
                    <div class="form-group input-group" >
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-transparent" style="background-color: transparent;" onclick="mostrarSenha()" type="button">
                                <img src="../../icones/svg/eye.svg" width="15" height="15">
                            </button>
                        </span>
                    </div>
                </div>
