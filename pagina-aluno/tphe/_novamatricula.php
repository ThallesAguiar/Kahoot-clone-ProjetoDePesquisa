 ...
 <body class="sticky-header left-side-collapsed">
    ...
    <!-- left side start-->
		...
		<div class="main-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Matricule-se</h1>
                </div>
                <!-- /.col-lg-12 -->
								
								
								<form role="form" action="../../pagina-painel-jogador/tphe/gravar_matricula.php" method="POST">
									...
									<?php 
										...
										//$sql = mysqli_query($cx, "SELECT * FROM `turma` WHERE `SIGLA`=".$sigla_turma);
